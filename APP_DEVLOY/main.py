...
import numpy as np
from transformers import AutoConfig, AutoModel, AutoTokenizer, XLMRobertaTokenizer
from processing.processing_subword import cutting_subword
from utils import merge_subtags, merge_subtags_3column
...
class NER(nn.Module):
    def __init__(self, dict_path, model_name, tag_value ,dropout = 0.4,  max_len = 256, batch_size = 32, device = 'cuda', concat=True):
        ...
        self.tokenizer = XLMRobertaTokenizer.from_pretrained(dict_path['tokenizer'], do_lower_case=False,use_fast=False)
